...
#df_exp = read.csv('2016 School Explorer.csv', header = T)
...
col_for_corr = c("EconomicNeedIndex","AverageELAProficiency","RigorousInstruction","CollaborativeTeachers",
                 "SupportiveEnvironment","StrongFamilyCommunityTies","Trust","EffectiveSchoolLeadership"
                 )
df_for_corr_2 = df_exp[, col_for_corr]
corr_mat = cor(df_for_corr_2)
#install.packages("corrplot")
library(corrplot)
corrplot(corr_mat, method="number",tl.cex=0.7,tl.srt=45,tl.col="black")
