...
boxplot(df_for_corr$Effective.School.Leadership.. ~ df_for_corr$Trust.., data = df_for_corr, xlab = "Trust", ylab = "Effective School Leadership", main = "Effective School Leadership")
...
plot(df_for_corr$Trust..,df_for_corr$Effective.School.Leadership..)
abline(lm(df_for_corr$Effective.School.Leadership..~df_for_corr$Trust..))


boxplot(df_for_corr$Effective.School.Leadership..)
boxplot(df_for_corr$Trust..)
boxplot(df_for_corr$Economic.Need.Index)
boxplot(df_for_corr$Strong.Family.Community.Ties..)
